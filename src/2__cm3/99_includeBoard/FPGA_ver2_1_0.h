...
#ifndef FPGA_ver1_2_1_H___
#define FPGA_ver1_2_1_H___
...
#if 0
			backterConfiguration_resetValue=0xB1,			// 백텔 안들어옴 (32, 39, 59, 119, 120, 121), 백텔 값오류(190) 4월 4주차
#else
			backterConfiguration_resetValue=0xA9,			//  백텔 안들어옴 (32, 39, 59, 119, 120, 121), 백텔 값오류(190)
#endif
