...
#ifndef isd_ver1_1_2_H__
#define isd_ver1_1_2_H__
...
typedef enum
{
    ...
    ISD_Power_LowUnstable = 0,
    ISD_Power_LowStable,
    ISD_Power_HighUnstable,
    ISD_Power_HighStable,
    NoBacktel,
    BackTelNumTooMuch,
    ISD_Power_NA
} EN_ISD_PowerState;
...
#define offsetDAC_A_Slope           2.27
#define offsetDAC_A_SaturationLevel 130
...
#define DAC_B_Slope                 3.15
#define DAC_B_Slope_SaturationLevel 255
#define DAC_C_Slope                 4.72
#define DAC_C_Slope_SaturationLevel 255
