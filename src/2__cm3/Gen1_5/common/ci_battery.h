...
#ifndef __Gen1_5_battery_h__
#define __Gen1_5_battery_h__
...
#define LSAD_INPUT_DIO_NUM    LSAD_INPUT_DIO23
#define LSAD_PRESCALE_NUM     LSAD_PRESCALE_3200
#define LSAD_INT_CH_NUM       LSAD_INT_CH0
#else  // Sound1 Test
#define LSAD_INPUT_SEL_CH_NUM 0
#define LSAD_INPUT_DIO_NUM    LSAD_INPUT_DIO22
#define LSAD_PRESCALE_NUM     LSAD_PRESCALE_3200
#define LSAD_INT_CH_NUM       LSAD_INT_CH0
#endif

#define CI_LASD_STABLE_CNT 4
