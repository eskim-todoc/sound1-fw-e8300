...
#define df_normalizeShiftBitNumFor10DBLibrary 5
...
#define RightShitmaxMagFreqScale 4
...
// FFT_size/32=512/32=16=2^4이다. 따라서 주파형 영역에서 구해진 크기 값을 4비트 오른쪽 쉬프트하면 시간영역에서 구한
// 크기가 된다.
...
// FFT_size/8=512/16=32=2^5이다. 따라서 주파형 영역에서 구해진 크기 값을 5비트 오른쪽 쉬프트하면 시간영역에서 구한
// 크기가 된다.
