...
#define TDC_TOUCH_RE_ATI_COOLDOWN_CNT       TDC_TIME_TO_CNT(TDC_TOUCH_RE_ATI_COOLDOWN_MS, TDC_TOUCH_POLL_INTERVAL_MS)       /* @200 = 10 */
#define TDC_TOUCH_READ_FAIL_HOLD_CNT        TDC_TIME_TO_CNT(TDC_TOUCH_READ_FAIL_HOLD_MS, TDC_TOUCH_POLL_INTERVAL_MS)        /* @200 = 10 */
#define TDC_TOUCH_BOOT_RELEASE_DEBOUNCE_CNT TDC_TIME_TO_CNT(TDC_TOUCH_BOOT_RELEASE_DEBOUNCE_MS, TDC_TOUCH_POLL_INTERVAL_MS) /* @200 = 2 */
...
#define TDC_TOUCH_ULP_NOTOUCH_DEBOUNCE_CNT TDC_TIME_TO_CNT(TDC_TOUCH_ULP_NOTOUCH_DEBOUNCE_MS, TDC_TOUCH_ULP_WAKE_MS) /* @200 = 2 */
#define TDC_TOUCH_ULP_FORCE_RESEED_CNT     TDC_TIME_TO_CNT(TDC_TOUCH_ULP_FORCE_RESEED_MS, TDC_TOUCH_ULP_WAKE_MS)     /* @200 = 50 */
#define TDC_TOUCH_ULP_REBOOT_TOUCH_CNT     TDC_TIME_TO_CNT(TDC_TOUCH_ULP_REBOOT_TOUCH_MS, TDC_TOUCH_ULP_WAKE_MS)     /* @200 = 2 */
