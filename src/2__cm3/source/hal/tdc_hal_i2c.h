#ifndef __tdc_hal_i2c_h__
#define __tdc_hal_i2c_h__
...
#define TDC_HAL_I2C_MASTER_PRESCALE_240 ((uint32_t) (0x4FU << I2C_CFG_MASTER_PRESCALE_Pos))  // 128    kHz
#define TDC_HAL_I2C_MASTER_PRESCALE_243 ((uint32_t) (0x50U << I2C_CFG_MASTER_PRESCALE_Pos))  // 126.42 kHz
...
// clang-format off
#define TDC_HAL_I2C_CFG_MASTER   ( TDC_HAL_I2C_MASTER_PRESCALE_240            \
                                   | I2C_STOP_INT_ENABLE                \
...
#define TDC_HAL_I2C_CLEAR_HW_STATUS ( I2C_OVERRUN_CLEAR                  \
                                   | I2C_BUS_ERROR_CLEAR                \
