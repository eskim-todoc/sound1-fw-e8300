...
#else
			//backterConfiguration_resetValue=0x29,			//  백텔 안들어옴 (32, 39, 59, 119, 120, 121), 백텔 값오류(190)
			backterConfiguration_resetValue=0x2D,			//  백텔 안들어옴 (32, 39, 59, 119, 120, 121), 백텔 값오류(190)
