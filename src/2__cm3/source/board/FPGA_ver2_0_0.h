...
#ifndef FPGA_ver1_2_0_H___
#define FPGA_ver1_2_0_H___
...
/// 레지스터  비트 위치
		...
		typedef enum
		{
			...
			FPGA_BitPosition_CarringCaseOpen=3,
		...
		typedef enum
		{
			FPGA_BitPosition_error_clkRate= 1,
...
/// 레지스터  상태 값
		...
		typedef enum
		{
			FPGA_BitFlag__Bifbacktel_bitLength_8bit=0,
			FPGA_BitFlag__Bifbacktel_bitLength_12bit=1,
			FPGA_BitFlag__Bifbacktel_backtel_On=1,
			FPGA_BitFlag__Bifbacktel_backtel_Off=0
		} FPGA_BACKTEL_REG_BITFLAG;
		...
		typedef enum
		{
			...
			systemResgister_2nd_resetValue = 0x06,
			stimulation_PhaseDuration_resetValue =0,
			backterConfiguration_resetValue=0xB0,
		...
		//
			...
			#define FPGA_TxPower_initValue									FPGA_TxPower_Min	//0~7
