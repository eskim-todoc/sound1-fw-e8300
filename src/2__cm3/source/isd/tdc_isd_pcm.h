...
#define pcm_Mold_BacktelConfiguration                                                                                                                          \
    0x60100  // 011-0-00000001(addr_PCM register_01)-xxxxxxxx(register Value) 	// 011-0-0000-0001-link모드(1=무선, 0=유선)-BackterCalibration(5bit, 유선=01010, 무선=01100이 기본값)-BacktelMode( 0=8bit register, 1=12bit adc) - BackterOnOff( 0=off, 1=0n)
