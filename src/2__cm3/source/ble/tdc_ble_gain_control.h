#ifndef __tdc_ble_gain_control_h__
#define __tdc_ble_gain_control_h__

/*
 * tdc_ble_gain_control.h
 *
...
/* Control type */
#define TDC_BLE_GAIN_CONTROL_TYPE_READ  0
#define TDC_BLE_GAIN_CONTROL_TYPE_WRITE 1

/* Gain type */
#define TDC_BLE_GAIN_TYPE_INVALID 0
#define TDC_BLE_GAIN_TYPE_A       1
#define TDC_BLE_GAIN_TYPE_B       2

/* 응답 코드 */
#define TDC_BLE_GAIN_RSP_FAILED  0
#define TDC_BLE_GAIN_RSP_SUCCESS 1
