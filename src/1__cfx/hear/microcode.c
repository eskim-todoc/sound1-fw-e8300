...
volatile int _XADDR(D_HEAR_A0MEM_BASE + HCT_FIFO_A0_2_START) HCT_A0_2[HCT_FIFO_A0_2_LENGTH];
...
volatile int _XADDR(D_HEAR_A0MEM_BASE + HCT_FIFO_A0_5_START) HCT_A0_5[HCT_FIFO_A0_5_LENGTH];
volatile int _XADDR(D_HEAR_A0MEM_BASE + HCT_FIFO_A0_6_START) HCT_A0_6[HCT_FIFO_A0_6_LENGTH];
