...
#define REF_CLK_DIO DIO22  // DMIC_CLK1/CAL

#define CI_LED_DIO_GREEN DIO15  // LED_G/UART_RX_E8300
#define CI_LED_DIO_BLUE  DIO12  // LED_B
#define CI_LED_DIO_RED   DIO8   // LED_R/UART_TX_E8300
