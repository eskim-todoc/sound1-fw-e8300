...
#define DAC_AO_CTRL_DISABLE_VAL                                                                                                                                \
    (AO0_UNMUTE | AO0_ATTENUATE_BYPASS | AO0_CURRENT_1_0X | AO0_DISABLE | AO0_LFP_OUT_ACTIVE_12KHZ | AO1_UNMUTE | AO1_ATTENUATE_BYPASS | AO1_CURRENT_1_0X      \
     | AO1_DISABLE | AO1_LFP_OUT_ACTIVE_12KHZ | DIFF_OUT_DISABLE | DIFF_OUT_CH0)
...
#define ADC_DEC_CTRL_VAL                                                                                                                                       \
    (BAND_SELECT_ADC_0K_8K | ADC_INTEGER_DELAY_0 | ADC_FRACTIONAL_DELAY_0 | ADC_UNMUTE | ADC_DEC_ENABLE | ADC_DC_REMOVE_CUTOFF_20HZ | SYS_CALC_GF)
...
#define OUTPUT_GAIN_VAL                                                                                                                                        \
    ((((uint32_t) 0x7FF << AUDIO_OUTPUT_GAIN_OUTPUT0_GAIN_Pos) & AUDIO_OUTPUT_GAIN_OUTPUT0_GAIN_Mask)                                                          \
     | (((uint32_t) 0x7FF << AUDIO_OUTPUT_GAIN_OUTPUT1_GAIN_Pos) & AUDIO_OUTPUT_GAIN_OUTPUT1_GAIN_Mask))
...
#define IOC_FIFO_ACCESS_VALUE                                                                                                                                  \
    (FIFO_A0_0_DBL_ACC_EN | FIFO_A0_1_DBL_ACC_EN | FIFO_A0_2_DBL_ACC_EN | FIFO_A0_3_DBL_ACC_EN | FIFO_A0_5_DBL_ACC_EN | FIFO_A0_6_DBL_ACC_EN)
...
/* Define the PCM DIO number */
#if 1  // Sullivan 1.5
#define DIO_PCM_CLK   DIO33
#define DIO_PCM_FRAME DIO6
#define DIO_PCM_SERO  DIO10
#else  // Sound1 Test
#define DIO_PCM_CLK   DIO32
#define DIO_PCM_FRAME DIO10
#define DIO_PCM_SERO  DIO13
#endif

/* Define the PCM configuration */
#define OTE1_5GEN_PCM_CFG                                                                                                                                      \
    (PCM_TX_ACK_DATA0 | PCM_RX_ACK_DATA0 | PCM_TX_DMA_DISABLE | PCM_RX_DMA_DISABLE | PCM_TX_IOC_ENABLE | PCM_RX_IOC_DISABLE | PCM_RX_TX_INT_DISABLE            \
     | PCM_OVERRUN_INT_DISABLE | PCM_UNDERRUN_INT_DISABLE | PCM_SAMPLE_RISING_EDGE | PCM_TX_DATA_ALIGN_LSB | PCM_RX_DATA_ALIGN_LSB | PCM_WORD_SIZE_20          \
     | PCM_BIT_ORDER_MSB_FIRST | PCM_FRAME_ALIGN_FIRST | PCM_FRAME_WIDTH_LONG | PCM_MULTIWORD_2 | PCM_SUBFRAME_DISABLE | PCM_SELECT_MASTER)
...
extern volatile int _XMEM g_earpiece_detection;
