...
#ifndef __driver_PCM_h__
#define __driver_PCM_h__
...
#define PCM_PREAMBLE_STATE_FILL_ZERO 0
#define PCM_PREAMBLE_STATE_TOGGLE    1
...
#define pcm_Mold_BacktelConfiguration 0x60100 // 011-0-0000-0001(addr_PCM register_01)-xxxxxxxx(register Value)
// 011-0-0000-0001-link모드(1=무선, 0=유선)-BackterCalibration(5bit, 유선=01010, 무선=01100이 기본값)-BacktelMode(0=8bit register, 1=12bit
// adc)-BacktelOnOff(0=off, 1=0n)
