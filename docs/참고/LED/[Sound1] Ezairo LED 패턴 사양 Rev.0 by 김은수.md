...
| 색 | RGB 합성 | duty 비율 (k_led_mix 기준) |
|---|---|---|
| BLACK | OFF | 0 / 0 / 0 |
| RED | R | 100 / 0 / 0 |
| GREEN | G | 0 / 100 / 0 |
| BLUE | B | 0 / 0 / 100 |
| ORANGE | R + G (노랑) | 100 / 100 / 0 |
| SKYBLUE | G + B | 0 / 30 / 40 |
| PURPLE | R + B | 100 / 0 / 100 |
| WHITE | R + G + B | 100 / 100 / 100 |

상세 색감 보정 (회로 단의 LED 종류별 색감 차이) 은 [`색감 관리 · 회로 보정.md`](색감%20관리%20·%20회로%20보정.md) 참조.
