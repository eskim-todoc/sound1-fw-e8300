...
```markdown
| NofM 튜닝 (프레임 3·백텔 강제·16ch 조건) | signalProcessing | nofm, frame-count, backtel, channel-config, tuning | [signalProcessing/nofm-tuning](signalProcessing/nofm-tuning/) | 완료 | 2026-05-14 ~ 2026-05-14 | ← [signalProcessing/nofm-merge](signalProcessing/nofm-merge/) (본체), ↔ [signalProcessing/cfx-cm3-analysis](signalProcessing/cfx-cm3-analysis/) (Rev.1 1ms PCM 틱), ↔ [ui/program-change-command](ui/program-change-command/) (--prog 3 진입) | ... 요약 |
```
