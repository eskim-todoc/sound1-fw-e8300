...
> [!NOTE]
> 본 문서는 [`tasks/touch/init-split/구현계획.md`](../init-split/구현계획.md)의 §11 "향후 작업"에서 승격된 Step B 계획이다. Step A(초기화 분할)는 2026-04-20에 구현·검증·병합 완료.

> [!TIP]
> **관련 문서**
> - [`tasks/touch/init-split/구현계획.md`](../init-split/구현계획.md) — Step A
