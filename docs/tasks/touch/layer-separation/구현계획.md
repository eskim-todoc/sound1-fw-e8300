...
> [!NOTE]
> 본 문서는 [`[구현계획] 터치 센서 초기화 분할 Rev.2 by 김은수.md`](%5B%EA%B5%AC%ED%98%84%EA%B3%84%ED%9A%8D%5D%20%ED%84%B0%EC%B9%98%20%EC%84%BC%EC%84%9C%20%EC%B4%88%EA%B8%B0%ED%99%94%20%EB%B6%84%ED%95%A0%20Rev.2%20by%20%EA%B9%80%EC%9D%80%EC%88%98.md)의 §11 "향후 작업"에서 승격된 Step B 계획이다. Step A(초기화 분할)는 2026-04-20에 구현·검증·병합 완료.

> [!TIP]
> **관련 문서**
> - [`[구현계획] 터치 센서 초기화 분할 Rev.2 by 김은수.md`](%5B%EA%B5%AC%ED%98%84%EA%B3%84%ED%9A%8D%5D%20%ED%84%B0%EC%B9%98%20%EC%84%BC%EC%84%9C%20%EC%B4%88%EA%B8%B0%ED%99%94%20%EB%B6%84%ED%95%A0%20Rev.2%20by%20%EA%B9%80%EC%9D%80%EC%88%98.md) — Step A
> - [`[분석] 터치센서 운용 방식.md`](%5B%EB%B6%84%EC%84%9D%5D%20%ED%84%B0%EC%B9%98%EC%84%BC%EC%84%9C%20%EC%9A%B4%EC%9A%A9%20%EB%B0%A9%EC%8B%9D.md)
> - [`[참고] IQS323 터치센서 레지스터 레퍼런스 by 김은수.md`](%5B%EC%B0%B8%EA%B3%A0%5D%20IQS323%20%ED%84%B0%EC%B9%98%EC%84%BC%EC%84%9C%20%EB%A0%88%EC%A7%80%EC%8A%A4%ED%84%B0%20%EB%A0%88%ED%8D%BC%EB%9F%B0%EC%8A%A4%20by%20%EA%B9%80%EC%9D%80%EC%88%98.md)
...
본 리팩터는 루트 네이밍 지침 [`[지침] [코딩] 네이밍 컨벤션.md`](../../../docs/%5B%EC%A7%80%EC%B9%A8%5D%20%5B%EC%BD%94%EB%94%A9%5D%20%EB%84%A4%EC%9D%B4%EB%B0%8D%20%EC%BB%A8%EB%B2%A4%EC%85%98.md)의 **`tdc_drv_<chip>` 역할 표식** 규칙을 따른다 (2026-04-20 개정).
...
| # | 항목 | 상태 | 비고 |
|---|---|---|---|
| 1 | 네이밍 컨벤션 `tdc_drv_<chip>` (§1.4) | ✅ 확정 | 루트 지침 2026-04-20 개정에 반영. 이후 모든 드라이버에 적용 |
| 2 | 상태 enum `TDC_TOUCH_STATE_CALIBRATION_ERROR` | ✅ 확정 | `ATI`는 IQS323 고유 용어라 제외. 터치 센서 전반에 범용적인 "캘리브레이션" 채택 |
