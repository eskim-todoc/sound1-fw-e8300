...
전체 시스템 레이어와 소스별 규칙은 [`[참고] LED 시스템 — 아키텍처 · 운용`]([참고]%20LED%20시스템%20—%20아키텍처%20·%20운용.md) 참조. 색감 (RGB 채널별 cap) 은 [`[참고] LED 시스템 — 색감 관리 · 회로 보정`]([참고]%20LED%20시스템%20—%20색감%20관리%20·%20회로%20보정.md) 참조.
...
- [`[참고] LED 시스템 — 아키텍처 · 운용.md`]([참고]%20LED%20시스템%20—%20아키텍처%20·%20운용.md) — 전체 레이어, arbiter, 패턴, 소스 규칙
- [`[참고] LED 시스템 — 색감 관리 · 회로 보정.md`]([참고]%20LED%20시스템%20—%20색감%20관리%20·%20회로%20보정.md) — 채널별 cap, 색상별 cap, 튜닝
