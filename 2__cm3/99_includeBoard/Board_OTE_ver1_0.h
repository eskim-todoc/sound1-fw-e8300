#ifndef Board_OTE_VER_1_0_H__
#define Board_OTE_VER_1_0_H__
...
//////////////
		...
		// CFX UART
		#define	DIO_PIN_INDEX_forUART_TX					DIO_PIN_INDEX_forPCM_FR
		#define	DIO_PIN_INDEX_forUART_RX					DIO_PIN_INDEX_forPCM_SERO
